...
- A weighted ensemble of both models for final recommendation generation.

The final submission model combines the predictions of SASRec and SVD using:

Score = 0.6 × SASRec + 0.4 × SVD
